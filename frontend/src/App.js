      ...
      <Route path='/admin'>
        <Admin theme={theme} dataProvider={api} authProvider={authProvider}>
          { permissions => [
            ...
            ['Admin', 'Campus_Admin'].includes(permissions) ? <Resource name='campus-admin' icon={AdminIcon} list={CampusAdminList} create={CampusAdminCreate} edit={CampusAdminEdit} show={CampusAdminShow} options={{ label: 'Adm. de Campus' }}/> : null,
            ...
            ['Admin', 'Campus_Admin', 'Internship-Sector'].includes(permissions) ? <Resource name='courses' icon={MenuBookIcon} list={CourseList} create={CourseCreate} edit={CourseEdit} show={CourseShow} options={{ label: 'Cursos' }}/> : null,
            ['Admin', 'Campus_Admin', 'Internship-Sector'].includes(permissions) ? <Resource name='companies' icon={BusinessIcon} list={CompanyList} create={CompanyCreate} edit={CompanyEdit} show={CompanyShow} options={{ label: 'Empresas' }}/> : null,
            ...
            ['Admin', 'Campus_Admin', 'Internship-Sector'].includes(permissions) ? <Resource name='interns' list={InternList} create={InternCreate} edit={InternEdit} show={InternShow} options={{ label: 'Estagiários' }}/> : null,
          ]}
        </Admin>
      </Route>
    </Router>
